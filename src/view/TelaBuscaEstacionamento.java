 ...
 * @author house
 */
public class TelaBuscaEstacionamento extends javax.swing.JDialog {

    /**
     * Creates new form TemplateCadastros2025
     */
    public TelaBuscaEstacionamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaEstacionamento dialog = new TelaBuscaEstacionamento(new javax.swing.JFrame(), true);
