 ...
 * @author house
 */
public class TelaBuscaCadastroProduto extends javax.swing.JDialog {

    /**
     * Creates new form TemplateCadastros2025
     */
    public TelaBuscaCadastroProduto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBoxFiltro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Nome", "Descrição" }));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaCadastroProduto dialog = new TelaBuscaCadastroProduto(new javax.swing.JFrame(), true);
